                                            ...
                                            <div class="col-lg-6  col-md-12 col-sm-12 ">
                                                <div id="what-is" class="card">
                                                    <div  class="card-header"   style="border-radius: 4px!important;">
                                                        <h4 class="card-title"><b>Что такое ImpulseGame?</b></h4>
                                                    ...
                                                    <div class="card-body collapse in">
                                                        <div class="card-block">
                                                            <div class="card-text">
                                                                ...
                                                                <ul>
                                                                    <li>ЦЕЛЫХ 10 рублей при вступлении в нашу группу</li>
...
if($prava == 1)
{
	...
	<li class="dropdown nav-item " style="float:right!impotant" onclick="window.open('/admin');">
                            <a class="dropdown-toggle nav-link"><span>Секретик</span></a>
                        </li>
HERE;
}
$panel = <<<HERE
                                                        ...
                                                        <div class="card-body collapse in">
                                                            <div class="card-block">
                                                                <form class="form-horizontal">
																	...
																	<div style="padding-bottom:11px" class="g-recaptcha" data-sitekey="6LdqrbkUAAAAAFd9uYRKfiBMxEuj1F1IZLY_zDwx"></div>
